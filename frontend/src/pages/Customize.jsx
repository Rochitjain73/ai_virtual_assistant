...
setFrontendImage(URL.createObjectURL(file))
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-t from-black to-[#030353] flex flex-col items-center p-[20px]">
      <MdKeyboardBackspace
      ...
      {selectedImage && (
        <button
          className="min-w-[150px] h-[60px] mt-[30px] text-white font-semibold cursor-pointer bg-[#1d1d8a] rounded-full text-[19px] hover:bg-[#3131b0] transition-colors"
