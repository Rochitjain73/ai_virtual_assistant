...
//       `Welcome to the world of ${userData.name}'s ${userData.assistantName}`
//     );
//     greeting.lang = "hi-IN";
//     window.speechSynthesis.speak(greeting);
...
//       {/* Collapsible History - bottom left */}
//       <div className="absolute left-[20px] bottom-[30px] text-white">
//         <h1
//           onClick={() => setShowHistory(!showHistory)}
//           className="font-semibold text-[19px] cursor-pointer underline underline-offset-4"
//         >
//           {showHistory ? "Hide" : "Show"} History ⌄
//         </h1>
//         {showHistory && (
//           <div className="mt-[10px] w-[300px] max-h-[300px] overflow-y-auto bg-[#00000080] rounded-lg p-[10px] backdrop-blur-md">
//             {userData.history
//               ?.slice(-10)
//               .reverse()
//               .map((his, index) => (
//                 <div
//                   key={index}
//                   className="text-gray-300 text-[16px] mb-[5px] truncate"
//                 >
//                   {his}
//                 </div>
//               ))}
  ...
  return (
    <div className="w-full h-[100vh] bg-gradient-to-t from-[black] to-[#02023d] flex justify-center items-center flex-col gap-[15px] overflow-hidden">
      ...
      >
        ...
        <div className="w-full h-[2px] bg-gray-400"></div>
        <h1 className="text-white font-semibold text-[19px]">History</h1>
        <div className="w-full max-h-[400px] overflow-y-auto flex flex-col gap-[10px]">
          {userData.history
            ?.slice(-10)
            .reverse()
            .map((his, idx) => (
              <div
                key={idx}
                className="text-gray-200 text-[16px] truncate w-full whitespace-nowrap overflow-hidden"
                title={his}
              >
                {his}
              </div>
      ...
      <BsClockHistory
        className="hidden lg:block text-white absolute top-[20px] left-[20px] w-[25px] h-[25px] cursor-pointer"
        onClick={() => setShowHistory(!showHistory)}
      />

      {showHistory && (
        <div className="hidden lg:flex flex-col gap-[20px] items-start absolute top-[60px] left-[20px] w-[300px] max-h-[80vh] bg-[#00000053] backdrop-blur-lg p-[20px] rounded-xl">
          <h1 className="text-white font-semibold text-[19px]">History</h1>
          <div className="w-full h-[2px] bg-gray-400"></div>
          <div className="w-full max-h-[500px] overflow-y-auto flex flex-col gap-[10px]">
            {userData.history
              ?.slice(-10)
              .reverse()
              .map((his, idx) => (
                <div
                  key={idx}
                  className="text-gray-200 text-[16px] w-full truncate"
                  title={his}
                >
                  {his}
                </div>
